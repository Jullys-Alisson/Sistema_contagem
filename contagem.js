...
//     if (contador == 0) {
//         console.log(contador + ": Zero" + lista_de_alunos [contador]) //concatenação
//     } else if (contador % 2 != 0) {// % (resto) se a divisão interia por 2 for igual a 1 = Impar
//         console.log(`${contador}: Ímpar: ${lista_de_alunos[contador]}`) // Interpolação - Use `${variável}
//     } else {
//         console.log(`${contador}: Par: ${lista_de_alunos[contador]}`)
//     }
